...
<section class="k-hero" id="hero" data-nwcs-section="hero">
	<div class="k-wrap">
		<div class="k-hero__grid">
			<div>
				<p class="k-hero__eyebrow"><?php echo esc_html( nwcs_field( 'home', 'hero', 'eyebrow' ) ); ?></p>
				<h1 class="k-hero__title"><?php echo esc_html( nwcs_field( 'home', 'hero', 'title' ) ); ?></h1>
				<p class="k-hero__desc"><?php echo esc_html( nwcs_field( 'home', 'hero', 'description' ) ); ?></p>
				<div class="k-hero__actions">
					<a class="k-btn k-btn--primary" href="<?php echo esc_url( kocist_link( nwcs_field( 'home', 'hero', 'primary_url' ) ) ); ?>">
						<?php echo esc_html( nwcs_field( 'home', 'hero', 'primary_label' ) ); ?>
					</a>
					<a class="k-btn k-btn--ghost" href="<?php echo esc_url( kocist_link( nwcs_field( 'home', 'hero', 'secondary_url' ) ) ); ?>">
