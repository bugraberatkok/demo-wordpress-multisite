...
<section class="k-section" id="yetkinlik" data-nwcs-section="capabilities">
	<div class="k-wrap">
		<div class="k-section-head">
			<h2 class="k-section-title"><?php echo esc_html( nwcs_field( 'home', 'capabilities', 'title' ) ); ?></h2>
			<p class="k-section-sub"><?php echo esc_html( nwcs_field( 'home', 'capabilities', 'subtitle' ) ); ?></p>
		</div>
