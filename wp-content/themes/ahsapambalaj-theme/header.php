...
<a href="#icerik" class="skip-link btn btn--sm btn--solid sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-[60]">
	İçeriğe geç
</a>
...
<header
	...
	<div class="mx-auto flex h-[88px] max-w-[76rem] items-center justify-between gap-8 px-6 transition-[height] duration-300 ease-out group-data-[stuck=true]:h-[64px]">
		...
		<div class="flex items-center gap-2">
			...
			<a href="<?php echo esc_url( ahsapambalaj_link( nwcs_field( 'global', 'header', 'cta_url' ) ) ); ?>"
	...
	<?php // Okuma cizgisi: sayfanin ne kadarinin okundugunu ahsap tonunda gosterir (assets/motion.js). ?>
	<span class="progress-line" data-progress aria-hidden="true"></span>
</header>
