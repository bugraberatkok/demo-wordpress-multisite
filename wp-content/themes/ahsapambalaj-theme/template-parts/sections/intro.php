...
<section class="mx-auto max-w-[76rem] px-6 pt-20 md:pt-28">
	...
	<div class="card mx-auto max-w-[66rem] px-7 py-9 text-center md:px-16 md:py-11" data-reveal>

		<span class="rule-draw mx-auto block h-[2px] w-12 bg-timber" aria-hidden="true"></span>
