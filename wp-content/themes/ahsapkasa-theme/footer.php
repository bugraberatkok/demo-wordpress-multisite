...
<footer class="mt-24 bg-night text-bone/85">
	<div class="mx-auto max-w-[76rem] px-6 py-16">
		...
		<div class="grid gap-12 md:grid-cols-[1.4fr_1fr_1fr]">
			...
			<div>
				<p class="font-display text-xl font-semibold text-bone" <?php nwcs_edit_attr( 'global', 'header', 'logo_text' ); ?>>
					<?php echo esc_html( nwcs_field( 'global', 'header', 'logo_text' ) ); ?>
					<span class="font-normal text-bone/60" <?php nwcs_edit_attr( 'global', 'header', 'logo_sub' ); ?>><?php echo esc_html( nwcs_field( 'global', 'header', 'logo_sub' ) ); ?></span>
				</p>
				...
				<p class="mt-8 text-sm text-bone/60">
					...
					<a href="<?php echo esc_url( ahsapkasa_link( nwcs_field( 'global', 'footer', 'external_url' ) ) ); ?>"
			...
			<div>
				...
				<ul class="mt-5 space-y-3 text-base">
					<li>
						<a href="<?php echo esc_url( ahsapkasa_link( nwcs_field( 'global', 'footer', 'phone_url' ) ) ); ?>"
					...
					<li class="pt-2 text-base/relaxed text-bone/65" <?php nwcs_edit_attr( 'global', 'footer', 'address' ); ?>>
						<?php echo ahsapkasa_multiline( nwcs_field( 'global', 'footer', 'address' ) ); // phpcs:ignore WordPress.Security.EscapingOutput ?>
					</li>
				</ul>
			</div>
		</div>
