...
require_once NWCS_DIR . 'includes/admin/product-tables.php';
require_once NWCS_DIR . 'includes/admin/pool-package.php';
...
require_once NWCS_DIR . 'includes/admin/bulk-content.php';
